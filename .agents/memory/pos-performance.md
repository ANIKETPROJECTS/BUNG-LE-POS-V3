...
**How to apply:** Prefer batch helpers for KOT-board responses and avoid retrying unavailable local printing every few seconds across multiple open tabs. Serialize QZ access locally when multiple tabs share a printer.